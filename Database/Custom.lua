...
function addon:InitCustom(DB)
	...
	self:addLookupList(DB, 36, "Sold on the Ascension web store.")
	self:addLookupList(DB, 37, "Sold by Tiraxis Ethereal Bazaar vendor.")
	self:addLookupList(DB, 38, "Challenge Mode")
	self:addLookupList(DB, 39, "Hidden in the world.")
	self:addLookupList(DB, 40, "Classic AQ, Scourge, or Legion invasion reward.")
